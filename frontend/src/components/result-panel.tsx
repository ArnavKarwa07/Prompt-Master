    ...
    <div className={cn("space-y-4", className)}>
      ...
      >
        <div className="flex items-center gap-2">
          <span className="text-sm text-muted-foreground">Analyzed by:</span>
          <Badge
            className={cn(
      ...
      >
        ...
        <p className="text-sm leading-relaxed">{result.routing.reasoning}</p>
      </motion.div>
      ...
      >
        <div className="flex items-center justify-between">
          ...
          <Button
            size="sm"
            variant="ghost"
            onClick={() => copyToClipboard(result.original_prompt, "original")}
            className="h-7 gap-2"
          >
            {copiedOriginal ? (
              <>
        ...
        <div className="bg-background/50 rounded-md p-4 border border-border/50">
          <p className="text-sm leading-relaxed whitespace-pre-wrap opacity-60">
