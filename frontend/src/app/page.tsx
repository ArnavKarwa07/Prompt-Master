    ...
    <div className="flex min-h-screen flex-col dark">
      ...
      <main className="flex-1 mesh-gradient">
          ...
          <div className="mx-auto max-w-7xl space-y-8">
            ...
            <div className="text-center space-y-4 mb-12">
              ...
              <p className="max-w-2xl mx-auto text-lg text-muted-foreground">
                Get instant feedback and optimized prompts from our specialized
                AI agents. No sign-up required to try it out.
              </p>
            </div>
          ...
          <div className="mx-auto max-w-4xl glass-strong rounded-2xl p-8 md:p-10">
            <div className="text-center mb-6">
              ...
              <p className="text-muted-foreground">
                Sign up to access premium features and save your optimization
                history
              </p>
            </div>
        ...
        <footer className="border-t border-white/10 mt-10">
          <div className="container px-8 md:px-12 py-10">
